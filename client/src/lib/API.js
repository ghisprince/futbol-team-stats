...
const baseURL = '/futbol/api/v1/'
const loginURL = baseURL + 'get_auth_token'
const competitionsURL = baseURL + 'competitions/'
const matchesURL = baseURL + 'matches/'
const opponentsURL = baseURL + 'opponents/'
const playerMatchesURL = baseURL + 'playermatches/'
const matchStatsURL = baseURL + 'matchstats/'
const playersURL = baseURL + 'players/'
const shotsURL = baseURL + 'shots/'
